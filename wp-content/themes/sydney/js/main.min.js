			...
			*/
			...
			if (currMenuType !== menuType) {
				...
				if (currMenuType === 'mobile') {
					...
					var pages = document.getElementsByClassName("page-wrap");
					for (var i = 0; i < pages.length; i++) {
						pages[i].style.marginTop = 0;
					}
					...
					if (headers.length > 0 && home.length == 0) {
						var h = window.getComputedStyle(headers[0]).getPropertyValue("height");
						var pages = document.getElementsByClassName("page-wrap");
                        // var pages = document.querySelectorAll(".page-wrap\\:not(.home)");
						for (var i = 0; i < pages.length; i++) {
							pages[i].style.marginTop = h;
						}
                    }
